...
public class ControlProtocol implements Runnable {
	...
	private void processDelete(){
		...
		this.server.getFileManager().removeAllChunks(this.fileId, this.fileEncryptedId,this.server.deleteVersion, this.server.lastModified); //fileEncrypted is the secretKey
